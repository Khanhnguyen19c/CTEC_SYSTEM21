...
class AllPersonalScoreboardComponent extends Component
{
    ...
    public function export_DSHP()
    {
        ...
        return (new ExcelExportScore(null))->download('Bảng điểm' . $this->getStudent()->HODEM . ' ' . $this->getStudent()->TEN . ' - ' . $this->getStudent()->MASV . '.xlsx');
    }

    public function export_CTDT()
    {

        return (new ExcelExportScoreCTDL(null))->download('Bảng điểm' . $this->getStudent()->HODEM . ' ' . $this->getStudent()->TEN . ' - ' . $this->getStudent()->MASV . '.xlsx');
    }

    public function export_HK()
    {

        return (new ExcelExportScoreHK(null))->download('Bảng điểm' . $this->getStudent()->HODEM . ' ' . $this->getStudent()->TEN . ' - ' . $this->getStudent()->MASV . '.xlsx');
    }
    ...
    public function render()
    {
        ...
        */
        ...
        return view('livewire.student.all-personal-scoreboard-component',
            [
            ...
            'layouts.layout',
            ['title' => 'Kết quả học tập' . Auth()->user()->name . ' - ' . Auth()->user()->sinhvien->lopchuyennganh->MALOPCHUYENNGANH]
        );
    }
}
