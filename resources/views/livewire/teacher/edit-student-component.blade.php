            ...
            <div class="container-xxl">
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <div class="col md-4">
                                <h3 class="fw-bold mb-0">Cập nhật</h3>
                            </div>
                ...
                <div class="row align-item-center">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-body">
                                <form method="POST" wire:submit.prevent="update_student()">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6" >
                                            ...
                                            <select  id="" class="form-control" wire:model="selectedlopchuyennganh">
                                                ...
                                                @if ($lopchuyennganh)
                                                @foreach ($lopchuyennganh as $item_lop)
                                                @foreach ($item_lop->lopchuyennganh as $itemlcn)
                                                <option value="{{$itemlcn->ID_LOPCHUYENNGANH}}">{{$itemlcn->MALOPCHUYENNGANH}}</option>
                                                @endforeach
                                                @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="file" id="formFileMultiple" wire:model="newhinhhoso">
                                            <div wire:loading wire:target="hinhhoso"> <i class="fa fa-spinner fa-pulse fa-fw"></i></div>
                                            @if ($newhinhhoso)
                                            <img src="{{$newhinhhoso->temporaryUrl() }}" width="250">
                                            @else
                                            <img src="{{asset('assets/images/Hoso')}}/{{$hinhhoso}}" alt="" width="250">
                                        @endif
                                            @error('newhinhhoso') <p class="text-danger">{{ $message }}</p> @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label for="formFileMultiple" class="form-label">Hình đại diện</label>
                                            <input class="form-control" type="file" id="formFileMultiple" wire:model="newhinhdaidien">
                                            <div wire:loading wire:target="hinhdaidien"> <i class="fa fa-spinner fa-pulse fa-fw"></i></div>
                                            @if ($newhinhdaidien)
                                            <img src="{{$newhinhdaidien->temporaryUrl() }}" width="250">
                                            @else
                                            <img src="{{asset('assets/images/Students')}}/{{$hinhdaidien}}" alt="" width="250">
                                        @endif
                                            @error('newhinhdaidien') <p class="text-danger">{{ $message }}</p> @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label for="emailaddress" class="form-label">Hộ khẩu</label>
                                            <input type="text" class="form-control" id="emailaddress" placeholder="Nhập địa chỉ"  wire:model="hokhau">
                                        ...
                                        <label for="lastname" class="form-label">Ghi Chú</label>
                                            <input type="text" class="form-control" id="lastname" wire:model="ghichu">
                                            @error('ghichu') <p class="text-danger">{{ $message }}</p> @enderror
                                        </div>
                                        <div class="col-md-6">
                                        <label for="lastname" class="form-label">Tài khoản ngân hàng (nếu có)</label>
                                            <input type="text" class="form-control" id="lastname" wire:model="sotaikhoan">
