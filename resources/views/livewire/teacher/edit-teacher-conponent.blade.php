            ...
            <div class="container-xxl">
                ...
                <div class="row align-item-center">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-body">
                                <form method="POST" wire:submit.prevent="update_teacher()">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="emailaddress" required wire:model="thinhgiang">
                                            @error('thinhgiang') <p class="text-danger">{{ $message }}</p> @enderror

                                        </div>
                                        <div class="col-md-6">
                                            <label for="emailaddress" class="form-label">Văn Bằng</label>
                                            <input type="text" class="form-control" id="emailaddress" required wire:model="vanbang">
                                        ...
                                        <div wire:loading wire:target="newimage"> <i class="fa fa-spinner fa-pulse fa-fw"></i></div>
                                            @if ($newimage)
                                                    <img src="{{$newimage->temporaryUrl() }}" width="175">
                                            @else
                                                    <img src="{{asset('assets/images/Teachers') }}/{{$image}}" width="175">
                                            @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="PHAI" id="" class="form-control" wire:model="nghiviec">
