                    ...
                    <div class="card border-0 mb-4 no-bg">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between  flex-wrap">
                            ...
                            <div class="col-auto d-flex w-sm-100">
                                ...
                                <a wire:click.prevent="export_password({{ $student->ID_SINHVIEN }})" onclick="confirm('Bạn có chắc muốn cấp lại mật khẩu cho sinh viên này không?') || event.stopImmediatePropagation()" class="btn btn-primary btn-sm">Cấp Lại Mật Khẩu</a>

                                <div class="dropdown" style="margin-right:45px;margin-left:20px">

                                    <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                        <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-toggle="dropdown">
                                            @if ($student->CANHBAOHV == 0 )
                                            Bình Thường
                                            @elseif ($student->CANHBAOHV == 1)
                                            Cảnh Báo Học Vụ
                                            @elseif ($student->CANHBAOHV == 2 && $student->XOATEN == 1)
                                            Đã Xoá Tên
                                            @else
                                            Đã Tốt Nghiệp
                                            @endif
                                    ...
                                    <ul class="dropdown-menu mr-4">
                                        @if ($student->CANHBAOHV == 0 )
                                        <li><a class="dropdown-item" href="#" wire:click.prevent="update_canhbaohv({{$student->ID_SINHVIEN}},1)">Cảnh Báo Học Vụ</a></li>
                                        <li><a class="dropdown-item" href="#" wire:click.prevent="update_canhbaohv({{$student->ID_SINHVIEN}},3)">Đã Tốt Nghiệp</a></li>
                                        @elseif ($student->CANHBAOHV == 1 )
                                        <li><a class="dropdown-item" href="#" wire:click.prevent="update_canhbaohv({{$student->ID_SINHVIEN}},2)">Xoá Tên</a></li>
                                        @endif
                                    </ul>
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-end">
                                <a href="{{route('student_edit',['id'=>$student->ID_SINHVIEN] ) }}"> <button type="button" class="btn btn-primary btn-lg my-1"><i class="fa fa-paper-plane-o"></i> Cập nhật</button></a>
                            </div>
                        </div> <!-- Row end  -->
                    </div>
